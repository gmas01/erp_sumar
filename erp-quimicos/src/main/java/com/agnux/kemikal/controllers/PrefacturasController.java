...
public class PrefacturasController {
    ...
    public @ResponseBody
    HashMap<String, ArrayList<HashMap<String, Object>>> getPrefacturasJson(
    ...
    public @ResponseBody
    HashMap<String, ArrayList<HashMap<String, Object>>> getAgentesParaBuscador(
            @RequestParam(value = "iu", required = true) String id_user_cod,
            Model model
    ) {
    ...
    public @ResponseBody
    HashMap<String, ArrayList<HashMap<String, Object>>> getPrefacturaJson(
    ...
    public @ResponseBody
    HashMap<String, ArrayList<HashMap<String, Integer>>> get_datos_generador_informeJson(Model model) {
    ...
    public @ResponseBody
    HashMap<String, ArrayList<HashMap<String, Object>>> getDataByNoClientJson(
    ...
    public @ResponseBody
    HashMap<String, ArrayList<HashMap<String, String>>> getRemisionesClienteJson(
    ...
    public @ResponseBody
    HashMap<String, ArrayList<HashMap<String, Object>>> getDatosRemisionJson(
    ...
    public @ResponseBody
    HashMap<String, HashMap<String, Object>> getPrecioUnitarioProductoJson(
            @RequestParam(value = "id_cliente", required = true) Integer id_cliente,
    ...
    public @ResponseBody
    HashMap<String, String> editJson(
            @RequestParam(value = "id_prefactura", required = true) Integer id_prefactura,
                        ...
                        if (!noPac.equals("0")) {
                            ...
                            if (cadRes[0].equals("true")) {
                                ...
                                if (parametros.get("formato_factura").equals("2")) {
                                    ...
                                    String params = String.format("-d -b sumarbill -o %s/%s.pdf -i rfc=%s;cfdi_xml=%s", outputDir, refId, rfcEmpresaEmisora, cfdi_xml);
                                    try {
    ...
    public @ResponseBody
    HashMap<String, String> logicDeleteJson(
